...
1. Run `orb harness .` and record the six dimension scores.
...
8. Run `orb audit` and `orb check`.
9. Re-run `orb harness .` and record the score delta in the SPEC evidence.
